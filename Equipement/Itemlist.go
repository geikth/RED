...
var Items = map[string]Item{
	...
	"Bandit_Boots":  {Name: "Bandit Boots", BonusDef: 8, BonusPV: 10, BonusSpeed: 10, MaxStack: 1, Type: "Boots"},
	"Bandit_Spear":  {Name: "Bandit Spear", BonusAtk: 10, MaxStack: 1, Type: "Weapon"},
	//T2 Ronin
	"Ronin_Helmet": {Name: "Ronin Helmet", BonusDef: 14, BonusPV: 20, MaxStack: 1, Type: "Helmet"},
	"Ronin_Armor":  {Name: "Ronin Armor", BonusDef: 20, BonusPV: 25, MaxStack: 1, Type: "Armor"},
	"Ronin_Boots":  {Name: "Ronin Boots", BonusDef: 16, BonusPV: 15, BonusSpeed: 20, MaxStack: 1, Type: "Boots"},
	"Ronin_Katana": {Name: "Ronin Katana", BonusAtk: 20, MaxStack: 1, Type: "Weapon"},
	//T1 Cuirrasé
	"Samourai_Helmet": {Name: "Knight Helmet", BonusDef: 10, BonusPV: 25, MaxStack: 1, Type: "Helmet"},
	"Samourai_Armor":  {Name: "Knight Armor", BonusDef: 16, BonusPV: 25, MaxStack: 1, Type: "Armor"},
	"Samourai_Boots":  {Name: "Knight Boots", BonusDef: 10, BonusPV: 15, BonusSpeed: 10, MaxStack: 1, Type: "Boots"},
	//T2 Cuirassé
	...
	//T1 Mage
	"Mage_Staff": {Name: "Mage Staff", BonusReiki: 20, MaxStack: 1, Type: "Weapon"},
	"Mage_Hood":  {Name: "Mage Hood", BonusReiki: 20, BonusPV: 15, MaxStack: 1, Type: "Helmet"},
	"Mage_Robe":  {Name: "Mage Robe", BonusReiki: 30, BonusPV: 20, MaxStack: 1, Type: "Armor"},
	"Mage_Boots": {Name: "Mage Boots", BonusReiki: 10, BonusPV: 15, MaxStack: 1, Type: "Boots"},
	//T2 Mage
	...
	//Craft (le stuff op)
	"Maximilian_Helmet": {Name: "Maximilian Helmet", BonusPV: 25, BonusSpeed: 10, BonusDef: 40, MaxStack: 1, Type: "Helmet"},
	"Maximilian_Armor":  {Name: "Maximilian Armor", BonusPV: 50, BonusAtk: 25, BonusDef: 60, MaxStack: 1, Type: "Armor"},
	"Maximilian_Boots":  {Name: "Maximilian Boots", BonusPV: 30, BonusSpeed: 20, BonusDef: 40, MaxStack: 1, Type: "Boots"},
	"La_Maxime":         {Name: "La Maxime", BonusAtk: 50, BonusSpeed: 10, BonusPV: 50, MaxStack: 1, Type: "Weapon"},
}
