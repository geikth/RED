...
var Items = map[string]Item{
	...
	"Bandit Boots":       {Name: "Bandit Boots", BonusDef: 7, BonusPV: 10},
	...
	"Samourai Boots":     {Name: "Knight Boots", BonusDef: 15, BonusPV: 15},
	"Lord Helmet":        {Name: "Lord Helmet", BonusDef: 30, BonusPV: 25},
	"Lord Armor":         {Name: "Lord Armor", BonusDef: 40, BonusPV: 35},
	"Lord Boots":         {Name: "Lord Boots", BonusDef: 20, BonusPV: 20},
